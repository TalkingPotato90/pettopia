-- USER 데이터 삽입
INSERT INTO USERS (USER_ID, ROLE, PROVIDER, PROVIDER_ID, EMAIL, NICKNAME, BIRTHDAY, GENDER, HAS_PET, PROFILE_IMG_URL, INTRODUCTION, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES ('NAVER_12345', 'ROLE_USER', 'NAVER', '12345', 'admin@example.com', 'AdminUser', '1985-05-15', 'F', FALSE, null, 'hello', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO USERS (USER_ID, ROLE, PROVIDER, PROVIDER_ID, EMAIL, NICKNAME, BIRTHDAY, GENDER, HAS_PET, PROFILE_IMG_URL, INTRODUCTION, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES ('KAKAO_12345', 'ROLE_USER', 'KAKAO', '12345', 'user1@example.com', 'UserOne', '1990-01-01', 'M', TRUE, null, 'hi', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO USERS (USER_ID, ROLE, PROVIDER, PROVIDER_ID, EMAIL, NICKNAME, BIRTHDAY, GENDER, HAS_PET, PROFILE_IMG_URL, INTRODUCTION, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES ('GOOGLE_12345', 'ROLE_USER', 'GOOGLE', '12345', 'user2@example.com', 'UserTwo', '1992-07-21', 'M', TRUE, null, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
...
INSERT INTO POST (POST_ID, CATEGORY_ID, USER_ID, TITLE, CONTENT, CREATED_AT, UPDATED_AT, VIEW, RECOMMEND, IS_DELETED)
VALUES (3, '1', 'GOOGLE_12345', 'Technical Tips', 'Here are some tips for beginners.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 100, 5, 1);
