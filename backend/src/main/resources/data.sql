...
INSERT INTO USERS (USER_ID, ROLE, PROVIDER, PROVIDER_ID, EMAIL, NICKNAME, HAS_PET, PROFILE_IMG_URL, INTRODUCTION, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES ('google_103847474649247952565', 'ROLE_USER', 'google', '103847474649247952565', 'mrb8215@gmail.com', '밀림의왕자레오', FALSE, null, null, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
...
-- COMMENT 데이터 삽입
INSERT INTO COMMENT (COMMENT_ID, POST_ID, USER_ID, NICKNAME,CONTENT, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES (1, 1, 'KAKAO_12345','바운디','Great post!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO COMMENT (COMMENT_ID, POST_ID, USER_ID,NICKNAME, CONTENT, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES (2, 2, 'NAVER_12345','그린애플', 'Thanks for the update!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO COMMENT (COMMENT_ID, POST_ID, USER_ID,NICKNAME, CONTENT, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES (3, 3, 'GOOGLE_12345','바운디', 'Helpful tips, thank you!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO COMMENT (COMMENT_ID, POST_ID, USER_ID,NICKNAME, CONTENT, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES (4, 1, 'google_107131721643965830645','유우리', 'Great post!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
INSERT INTO COMMENT (COMMENT_ID, POST_ID, USER_ID,NICKNAME, CONTENT, CREATED_AT, UPDATED_AT, IS_DELETED)
VALUES (5, 2, 'google_107131721643965830645','히게단디즘', 'Thanks for the update!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
